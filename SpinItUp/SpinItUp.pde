...
void setup() {
    ...
    gameStart_bgm = minim.loadFile("gameStartBGM.mp3");
    gameRun_bgm = minim.loadFile("gameRunBGM.mp3");
    bounce = minim.loadSample("bounce.wav", 128);
    hit = minim.loadSample("hit.wav", 128);
    addScore = minim.loadSample("score.wav", 128);
    tap = minim.loadSample("tap.wav", 128);
    fireHit = minim.loadSample("fireHit.wav", 128);
    fly = minim.loadSample("fly.wav", 128);
